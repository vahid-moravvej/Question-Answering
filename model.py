...
from qasystem.qa_model.inputHandler import create_train_dev_set
...
class SiameseBiLSTM:
    ...
    def train_model(self, sentences_pair, is_similar, embedding_meta_data, model_save_directory='./'):
        ...
        #STAMP = 'lstm_%s_%d_%d_%.2f_%.2f' % ('subject',self.number_lstm_units, self.number_dense_units, self.rate_drop_lstm, self.rate_drop_dense)
